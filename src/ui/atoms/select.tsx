...
export const Select = ({ className = undefined, currentValue = undefined, decoration = undefined, disabled = false, error = undefined, items, label = undefined, onBlur = undefined, onChange = undefined, containerClassName = undefined, containerStyle = undefined, style = undefined, x = 2 }: { items: string[] | Record<string, any> } & any) => {
    if (error) {
